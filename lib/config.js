...
console.log(config.get('PRIVATE_JWK'))
console.log(config.get('PORT'))
console.log(config.get('HOST'))
console.log(config.get('PGHOST'))
console.log(config.get('PGUSER'))
console.log(config.get('PGPORT'))
console.log(config.get('PGPASSWORD'))
console.log(config.get('PGDATABASE'))
console.log(config.get('NODE_ENV'))
console.log(config.get('APP_NAME'))
console.log(config.get('APM_SERVER'))
console.log(config.get('APM_TOKEN'))
